---
title: "Ring_layout：Flutter 环形布局实现"
...
在上面的定义中并未提及圆 a 的半径关系，实际上圆 a 的半径是可以不一致的，把圆 a 看作子元素的 [外切圆](https://baike.baidu.com/item/外切圆/4186184?fr=aladdin)，在复杂的生产环境中子元素的外切圆半径往往是不一致的，所以我们还需要确定 **圆 a 的最大半径** 。
...
为了满足子元素环形排列的需要，最大子元素的外切圆上限需为 $ 90^\circ $ 扇形的 [内切圆](https://baike.baidu.com/item/内切圆)，如下图所示。
